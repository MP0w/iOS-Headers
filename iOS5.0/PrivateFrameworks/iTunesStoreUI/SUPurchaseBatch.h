...
@property(nonatomic) BOOL storeShouldExitWhenFinished; // @synthesize storeShouldExitWhenFinished=_shouldSuspendWhenFinished;
- (void)_validateItems;
- (id)_copyValidPurchasesForItems:(id)arg1 shouldExit:(char *)arg2;

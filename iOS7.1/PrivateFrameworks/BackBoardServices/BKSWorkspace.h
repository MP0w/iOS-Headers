...
- (void)_sendMessage:(long long)arg1 withMessagePacker:(CDUnknownBlockType)arg2 replyHandler:(CDUnknownBlockType)arg3 replyQueue:(id)arg4;
- (void)_sendMessage:(long long)arg1 withMessagePacker:(CDUnknownBlockType)arg2 replyHandler:(CDUnknownBlockType)arg3;
- (void)_sendMessage:(long long)arg1 withMessagePacker:(CDUnknownBlockType)arg2;
...
- (void)elapsedCPUTimesForApplications:(id)arg1 completion:(CDUnknownBlockType)arg2;
...
- (void)_setupForActivationForBundleID:(id)arg1 activationSettings:(id)arg2 withResult:(CDUnknownBlockType)arg3;

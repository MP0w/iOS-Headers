...
@class PLManagedAsset, PUPhotoBrowserZoomTransition;
...
- (id)zoomTransition:(PUPhotoBrowserZoomTransition *)arg1 photoTokenForPhoto:(PLManagedAsset *)arg2 inCollection:(id <PLAssetContainer>)arg3;

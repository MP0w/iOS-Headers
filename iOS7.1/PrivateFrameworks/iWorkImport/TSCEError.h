...
+ (void)raiseErrorForInvalidReference:(CDStruct_5744d895)arg1 orString:(id)arg2 contextEntityID:(struct __CFUUID *)arg3 invalidMergeReference:(BOOL)arg4 disqualifiedFromEndCell:(BOOL)arg5;

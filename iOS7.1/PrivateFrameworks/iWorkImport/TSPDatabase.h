...
- (void).cxx_destruct;
- (set_149bae43 *)newRelationshipTargetsForSourceIdentifier:(long long)arg1 error:(id *)arg2;
...
- (set_149bae43 *)filterIdentifiers:(const set_149bae43 *)arg1 error:(id *)arg2;

...
@class CLLocation, CLLocationManager, NSArray, NSDate, NSMutableSet, NSTimer, PDDatabaseManager, SBSCardItemsController;
...
- (void)_addDateRelevantAndLocationPendingCardsForStyle:(unsigned int)arg1 locationAvailable:(BOOL)arg2;
...
- (void)_performProximitySearchAfterDelayingForAuthorization:(CDUnknownBlockType)arg1;

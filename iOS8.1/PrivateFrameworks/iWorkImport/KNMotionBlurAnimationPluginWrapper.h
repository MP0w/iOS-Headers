...
- (struct CATransform3D)p_projectionTransformWithType:(int)arg1 customProjectionTransform:(struct CATransform3D)arg2 context:(id)arg3 animationContext:(id)arg4;

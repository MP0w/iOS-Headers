...
- (void)setMinSizeForVMCachedResource:(int)arg1 withIdentifier:(NSString *)arg2;
- (void)currentDiskUsageWithIdentifier:(NSString *)arg1 completionHandler:(void (^)(int))arg2;
- (void)setMaxSize:(int)arg1 withIdentifier:(NSString *)arg2;
...
- (void)createStorageTaskManagerForPath:(NSString *)arg1 maxSize:(int)arg2 extension:(NSData *)arg3 withIdentifier:(NSString *)arg4;
@end

...
@class GKUITheme, NSString, UILabel;
...
@property(retain, nonatomic) UIView *rightOrnamentView; // @synthesize rightOrnamentView=_rightOrnamentView;
@property(retain, nonatomic) UIView *leftOrnamentView; // @synthesize leftOrnamentView=_leftOrnamentView;
...
- (struct CGSize)sizeForPrimaryText;
- (void)dealloc;
- (id)init;

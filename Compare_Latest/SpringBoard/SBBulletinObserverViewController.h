...
@interface SBBulletinObserverViewController : UIViewController <BBObserverDelegate, SBBulletinViewControllerDelegate, SBWidgetViewControllerHostDelegate, SBNotificationCenterWidgetHost>
{
    ...
    struct {
        unsigned int shouldPushUpdatesToView:1;
...
@property(retain, nonatomic) SBBulletinViewController *bulletinViewController; // @synthesize bulletinViewController=_bulletinViewController;
- (void)hostDidDismiss;
...
- (void)_sortVisibleSectionsForCategory:(int)arg1;
- (void)clearSection:(id)arg1;
- (void)removeAndDisableSection:(id)arg1;
- (void)removeSection:(id)arg1;
- (void)addSection:(id)arg1 inCategory:(int)arg2;
...
- (unsigned int)_indexOfSectionWithIdentifier:(id)arg1;
...
- (void)_setShouldPushUpdatesToView:(BOOL)arg1;

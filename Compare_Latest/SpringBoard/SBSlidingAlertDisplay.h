...
- (void)setShowingDeviceLock:(_Bool)arg1 duration:(double)arg2 completion:(id)arg3 outDuration:(void)arg4;
- (void)setShowingDeviceLock:(_Bool)arg1 duration:(double)arg2 completion:(id)arg3;
- (id)deviceLockView;

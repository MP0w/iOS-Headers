...
@class NSObject<OS_dispatch_queue>, SBAppSliderSettings, SBAppSwitcherStatusBarViewCache, SBApplication, SBSnapshotImageInfo, SBWallpaperEffectView, SBZoomableCrossfadeView, UIImage, UIImageView, UIView<SBAppSwitcherCacheVended>;

...
@class NSArray, NSDictionary, NSMutableArray, NSMutableDictionary, NSMutableSet, NSObject<OS_dispatch_queue>, NSString, SBAppSliderContainer, SBAppSliderIconController, SBAppSliderScrollingViewController, SBAppSliderSettings, SBAppSwitcherServices, SBAppSwitcherStatusBarViewCache, UIView;
...
- (_Bool)sliderScrollerIsRelayoutBlocked:(id)arg1;

...
- (void)_logDescriptionWithSuperclasses:(_Bool)arg1 indentation:(int)arg2 toLogger:(id)arg3;
...
- (id)_initWithClass:(unsigned long long)arg1 realizedOnly:(_Bool)arg2 infoMap:(id)arg3 symbolicator:(struct _CSTypeRef)arg4 type:(int)arg5 memoryReader:(id)arg6;

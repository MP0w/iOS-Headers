...
@class NSIndexPath, NSMutableSet, NSOrderedSet, PLAvalanche, PLManagedAsset, PUAvalancheReporter, PUAvalancheReviewCollectionViewLayout, PUAvalancheReviewControllerSpec, PUImageManager, PUPhotoBrowserController, PUPhotoPinchGestureRecognizer, PUPhotosSharingTransitionContext, PUPhotosZoomingSharingGridCell, PUReviewInstructionalView, PUReviewScrubber, PUTransitionViewAnimator, UIBarButtonItem, UICollectionView, UICollectionViewLayout, UITapGestureRecognizer;
...
- (void)_promoteFavoriteAssetsAndDissolveBurst:(BOOL)arg1 withReviewCompletionHandler:(CDUnknownBlockType)arg2;

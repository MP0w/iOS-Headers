...
- (int)bitBlt:(id)arg1:(int)arg2:(int)arg3:(int)arg4:(int)arg5:(id)arg6:(int)arg7:(int)arg8:(unsigned long)arg9:(CDStruct_265c7ca9 *)arg10:(unsigned long)arg11;
- (int)stretchBlt:(id)arg1:(int)arg2:(int)arg3:(int)arg4:(int)arg5:(id)arg6:(int)arg7:(int)arg8:(int)arg9:(int)arg10:(unsigned long)arg11:(CDStruct_265c7ca9 *)arg12:(unsigned long)arg13;
- (int)maskBlt:(id)arg1:(int)arg2:(int)arg3:(int)arg4:(int)arg5:(id)arg6:(int)arg7:(int)arg8:(id)arg9:(int)arg10:(int)arg11:(unsigned long)arg12:(CDStruct_265c7ca9 *)arg13:(unsigned long)arg14;
- (int)plgBlt:(id)arg1:(struct CGPoint *)arg2:(id)arg3:(int)arg4:(int)arg5:(int)arg6:(int)arg7:(id)arg8:(int)arg9:(int)arg10:(CDStruct_265c7ca9 *)arg11:(unsigned long)arg12;

...
@interface SWBluetoothRemote : SWRemote
{
    ...
    _Bool _playKeyWasDown;
    _Bool _volumeUpKeyWasDown;
    _Bool _volumeDownKeyWasDown;
    _Bool _leftKeyWasDown;
    _Bool _rightKeyWasDown;
    _Bool _nikeKeyWasDown;
}
...
- (void)_handleNikeKeyIsDown:(_Bool)arg1;
- (void)_handleSimpleRemoteRightKeyUpTimer:(id)arg1;
- (void)_handleSimpleRemoteRightKeyIsDown:(_Bool)arg1;
- (void)_handleSimpleRemoteLeftKeyUpTimer:(id)arg1;
- (void)_handleSimpleRemoteLeftKeyIsDown:(_Bool)arg1;
- (void)_handleSimpleRemoteVolumeDownKeyUpTimer:(id)arg1;
- (void)_handleSimpleRemoteVolumeDownKeyIsDown:(_Bool)arg1;
- (void)_handleSimpleRemoteVolumeUpKeyUpTimer:(id)arg1;
- (void)_handleSimpleRemoteVolumeUpKeyIsDown:(_Bool)arg1;
- (void)_handleSimpleRemotePlayKeyUpTimer:(id)arg1;
- (void)_handleSimpleRemotePlayKeyIsDown:(_Bool)arg1;

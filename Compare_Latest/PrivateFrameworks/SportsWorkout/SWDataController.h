...
- (void)setCalibrationData:(id)arg1 forSensorSerialNumber:(id)arg2 date:(id)arg3 isWalk:(_Bool)arg4;
...
- (_Bool)_workoutIsSynced:(id)arg1;
- (id)latestWorkout;
- (id)unsyncedWorkouts;
- (id)syncedWorkouts;
- (id)allWorkouts;
...
- (id)_entitiesOfTypeName:(id)arg1 forPropertyName:(id)arg2 isNull:(_Bool)arg3;

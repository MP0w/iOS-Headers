...
- (void)dealloc;
- (id)initWithMasterLayout:(id)arg1 range:(CDStruct_5f1f7aa9)arg2 flags:(unsigned long)arg3;
- (id)initWithLayout:(id)arg1 range:(CDStruct_5f1f7aa9)arg2 flags:(unsigned long)arg3;

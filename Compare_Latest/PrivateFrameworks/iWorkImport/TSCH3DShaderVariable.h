...
+ (id)variableWithName:(id)arg1 type:(struct NSString *)arg2 precision:(struct NSString *)arg3 arraySize:(unsigned int)arg4 shaderType:(struct TSCH3DShaderType)arg5 isSpecial:(BOOL)arg6 generic:(id)arg7;
...
- (void)dealloc;
- (id)initWithName:(id)arg1 type:(struct NSString *)arg2 precision:(struct NSString *)arg3 arraySize:(unsigned int)arg4 shaderType:(struct TSCH3DShaderType)arg5 isSpecial:(BOOL)arg6 generic:(id)arg7;

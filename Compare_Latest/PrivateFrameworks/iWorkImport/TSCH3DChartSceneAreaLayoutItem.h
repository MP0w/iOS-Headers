...
- (const struct ChartProjectedBoundsSpaces *)projectedBoundsWithScene:(id)arg1 allowsEmptyBodyLayoutBounds:(BOOL)arg2;
@property(readonly, nonatomic) const struct ChartProjectedBoundsSpaces *projectedBounds;
- (id)boundsLayout;
- (id)boundsLayout:(struct CGRect)arg1 scene:(id)arg2 allowsEmptyBodyLayoutBounds:(BOOL)arg3;

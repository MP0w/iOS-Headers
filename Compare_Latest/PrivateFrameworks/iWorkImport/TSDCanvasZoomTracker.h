...
- (void)p_finishZoomWithFinalScaleFactor:(float)arg1 contentOffset:(struct CGPoint)arg2;
- (void)zoomWithScale:(float)arg1 velocity:(float)arg2 locationInView:(struct CGPoint)arg3 phase:(int)arg4;

...
- (double)opacityByApplyingAnimation:(id)arg1 atTime:(double)arg2;
- (struct CATransform3D)transform3DByApplyingAnimation:(id)arg1 atTime:(double)arg2 offset:(struct CGPoint)arg3 parentFrame:(struct CGRect)arg4;
- (struct CATransform3D)transform3DByApplyingAnimation:(id)arg1 atTime:(double)arg2;

...
- (struct CGSize)p_drawAndOffsetMultiDataSliderIntoContext:(struct CGContext *)arg1 size:(struct CGSize)arg2 contentsScale:(float)arg3;
- (void)p_drawUnshadowedContentIntoContext:(struct CGContext *)arg1 size:(struct CGSize)arg2 contentsScale:(float)arg3 preset:(id)arg4;

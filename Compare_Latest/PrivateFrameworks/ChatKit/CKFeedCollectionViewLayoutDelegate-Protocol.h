...
- (struct CKFeedSeparatorMetrics)collectionView:(UICollectionView *)arg1 layout:(CKFeedCollectionViewLayout *)arg2 metricsForSeparatorBetweenSection:(int)arg3 andSection:(int)arg4 proposedMetrics:(struct CKFeedSeparatorMetrics)arg5;
- (struct CGSize)collectionView:(UICollectionView *)arg1 layout:(CKFeedCollectionViewLayout *)arg2 sizeForFooterInSection:(int)arg3 proposedSize:(struct CGSize)arg4;
...
- (struct CGSize)collectionView:(UICollectionView *)arg1 layout:(CKFeedCollectionViewLayout *)arg2 sizeForThumbnailInSection:(int)arg3;
...
- (struct UIEdgeInsets)collectionView:(UICollectionView *)arg1 layout:(CKFeedCollectionViewLayout *)arg2 contentInsetsForSection:(int)arg3;

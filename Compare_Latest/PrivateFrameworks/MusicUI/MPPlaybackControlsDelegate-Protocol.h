...
@optional
- (void)controlsOverlay:(MPPlaybackControlsView *)arg1 didTapTrackInfoButtonForItem:(MPAVItem *)arg2;
- (void)controlsOverlay:(MPPlaybackControlsView *)arg1 didTapRadioShareButtonForItem:(MPAVItem *)arg2;
- (void)controlsOverlay:(MPPlaybackControlsView *)arg1 didTapRadioHistoryButtonForItem:(MPAVItem *)arg2;
- (void)controlsOverlay:(MPPlaybackControlsView *)arg1 didTapRadioButtonForItem:(MPAVItem *)arg2;
- (BOOL)controlsOverlay:(MPPlaybackControlsView *)arg1 shouldHideRadioButtonForItem:(MPAVItem *)arg2;

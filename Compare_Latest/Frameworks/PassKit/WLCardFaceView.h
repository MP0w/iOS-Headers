...
@class NSArray, NSMutableArray, NSMutableSet, PKPass, UIImage, UIImageView, UIView, WLBarCodeStickerView, WLCardColorProfile, WLCardFaceTemplate;
...
@property(nonatomic) id <WLCardFaceDelegate> delegate; // @synthesize delegate=_delegate;
...
@property(readonly, nonatomic) WLCardColorProfile *colorProfile; // @synthesize colorProfile=_colorProfile;

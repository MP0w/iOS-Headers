...
- (id)_predicateForPassTypes:(unsigned int)arg1;
...
- (BOOL)paymentApplication:(id)arg1 isEnabledForNotificationServiceOfType:(int)arg2;
...
- (void)truncateMessagesFromPaymentPassWithUniqueIdentifier:(id)arg1 toCount:(unsigned int)arg2;
- (void)truncateTransactionsFromPaymentPassWithUniqueIdentifier:(id)arg1 toCount:(unsigned int)arg2;
...
- (void)getCatalog:(id *)arg1 passes:(id *)arg2 ofPassTypes:(unsigned int)arg3 limitResults:(BOOL)arg4;

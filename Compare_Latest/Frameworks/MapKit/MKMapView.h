...
+ (CDStruct_02837cd9)_mapRectThatFitsViewBounds:(struct CGRect)arg1 centeringRect:(struct CGRect)arg2 mapRect:(CDStruct_02837cd9)arg3 edgePadding:(struct UIEdgeInsets)arg4;
...
- (CDStruct_0c7fa811)_zoomRegionForMapRect:(CDStruct_02837cd9)arg1 edgePadding:(struct UIEdgeInsets)arg2 maxZoomLevel:(int)arg3 minZoomLevel:(int)arg4;
...
- (CDStruct_02837cd9)_convertDoubleRect:(struct CADoubleRect)arg1 toMapRectFromView:(id)arg2;

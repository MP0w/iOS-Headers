...
- (void)_scheduleDisplayInMapRect:(CDStruct_90e2a262)arg1 zoomScale:(float)arg2 preFlush:(BOOL)arg3 inBackground:(BOOL)arg4;
- (void)_displayInMapRectObj:(id)arg1 zoomScaleObj:(id)arg2 flush:(id)arg3;
- (void)_displayInMapRect:(CDStruct_90e2a262)arg1 zoomScale:(float)arg2;
...
- (CDStruct_90e2a262)_visibleMapRect;
- (CDStruct_90e2a262)_boundingMapRect;
- (void)set_boundingMapRect:(CDStruct_90e2a262)arg1;
- (void)_invalidateTilesInMapRect:(CDStruct_90e2a262)arg1;
...
- (struct CADoubleRect)_miniLayerRectForMapRect:(CDStruct_90e2a262)arg1;
- (void)dealloc;

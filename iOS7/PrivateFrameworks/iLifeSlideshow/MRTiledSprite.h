...
- (_Bool)getVerticesCoordinates:(struct CGPoint (*)[4])arg1 withMatrix:(float [16])arg2;
- (_Bool)hitAtPoint:(struct CGPoint)arg1 withInverseMatrix:(float [16])arg2 localPoint:(struct CGPoint *)arg3;
...
- (void)setNeedsTextureCoordinates:(_Bool)arg1 onTextureUnit:(unsigned long long)arg2;

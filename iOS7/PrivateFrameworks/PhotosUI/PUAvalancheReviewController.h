...
@class NSIndexPath, NSMutableSet, PLAvalanche, PLManagedAsset, PUAvalancheReporter, PUAvalancheReviewCollectionViewLayout, PUAvalancheReviewControllerSpec, PUImageManager, PUPhotoBrowserController, PUPhotosSharingTransitionContext, PUReviewInstructionalView, PUReviewScrubber, UIBarButtonItem, UICollectionView, UICollectionViewLayout, UITapGestureRecognizer;
